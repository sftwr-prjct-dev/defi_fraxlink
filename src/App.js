...
function App() {
  ...
  <div className="wrapper">
    <aside className="sidebar">
      ...
      <div className="sidebar-cta  border-bottom--gray background--black">
        ...
        <div className="sc-bdfBwQ sc-citwmv gqhTfM kajamm"><label className="sc-jcVebW hrCIoP"><input type="radio" name="radio-group-redeem" className="sc-bZSQDF eUgDnc form-check-input" defaultValue="yea" /><span className="sc-iUuytg esdhrP checkmark unlocked" />Min (~5%)</label><label className="sc-jcVebW hrCIoP"><input type="radio" name="radio-group-redeem" className="sc-bZSQDF eUgDnc form-check-input" defaultChecked /><span className="sc-iUuytg esdhrP checkmark locked" />Max</label></div>
      </div>
