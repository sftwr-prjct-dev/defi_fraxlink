        ...
        <aside className="sidebar">
          <div className="sidebar__header">
            <img
              ...
              size={45}
              src="/img/FRAX_Logo_White.e2bdd44d.svg"
              alt="Logo img"
            />
          ...
          <div className="flex--center background--gray border-bottom--gray">
            <div className="flex--center flex--3 border-right--gray">
              <a target="_blank" className="text--blue font--13">
                FRAX
              </a>
            </div>
            <div className="flex--center flex--9">
              <div>
                <img
                  width={11}
                  height={11}
                  src="/img/FRAX_Logo_White.7cc618db.png"
                  alt="FRAX Logo"
            ...
            <div className="flex--center flex--9">
              <div>
                <img
                  width={11}
                  height={11}
                  src="/img/FXS_Logo_White.a6e03692.png"
                  alt="FXS Logo"
          ...
          <div className="sidebar-cta flex--center border-bottom--gray background--black">
            <button className="sidebar-cta__btn background--gray">
          ...
          <div className="sidebar-cta flex--center border-bottom--gray background--black">
            ...
            <div
              ...
              data-for="slippage-tip"
              data-tip="The slippage tolerance is needed in case there are other Frax transactions in the same block."
              currentitem="false"
            >
              <svg
                stroke="currentColor"
