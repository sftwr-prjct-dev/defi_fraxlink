    ...
    <div className="font-poppins mint-screen text-white">
        <div className="md:flex">
          <div className="md:w-1/4">
            <p className="text-center md:p-3 text-white font-sans md:text-2xl font-bold bg-black">REDEEM</p>
          </div>
        ...
        <div className="md:flex md:justify-between md:h-5/6 mt-5">
          <div className="md:mt-48 md:w-1/4 mt-2">
            <div className="flex justify-center content-center">
              ...
              <div className="text-center pt-3">
                ...
                <input type="text" placeholder="Amount" className="rounded border border-gray-300 text-center text-sm"/>
              </div>
            </div>
          ...
          <div className="md:w-2/4 mt-10 md:mt-28 md:mb-32">
            <div className="grid place-items-end">
              <div className="redeem-border w-11/12 flex md:mt-16 mt-6">
                <div className="px-3 p-2 text-white text-center redeem-ends text-sm">0.45%</div>
                ...
                <div className="text-white p-2 text-center redeem-ends text-sm">
                  <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 16 16" color="#4BC0C0" height="22" width="22" xmlns="http://www.w3.org/2000/svg"><path d="M12.14 8.753l-5.482 4.796c-.646.566-1.658.106-1.658-.753V3.204a1 1 0 011.659-.753l5.48 4.796a1 1 0 010 1.506z"></path></svg>
                  </div>
                </div>
          ...
          <div className="md:my-auto md:mx-auto">
              ...
              <div className="text-center">
                <input type="text" placeholder="-" className="rounded border border-gray-300 text-center text-sm"/>
              </div>
            </div>
            </div>
            ...
            <div className="mx-auto">
              <div className="flex justify-center">
              <img src="https://app.frax.finance/static/media/FXS_Logo_White.a6e03692.png" width="25" height="3"/>
              <div className="text-center">
                <input type="text" placeholder="-" className="rounded border border-gray-300 text-center text-sm"/>
              </div>
            </div>
          ...
          <div className="flex absolute right-0">
            ...
            <span className="mr-4">
              <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" color="#007bff" height="30" width="30" xmlns="http://www.w3.org/2000/svg"><path d="M11 18h2v-2h-2v2zm1-16C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm0-14c-2.21 0-4 1.79-4 4h2c0-1.1.9-2 2-2s2 .9 2 2c0 2-3 1.75-3 5h2c0-2.25 3-2.5 3-5 0-2.21-1.79-4-4-4z"></path></svg>
            </span>
          </div>
        </div>
    </div>
