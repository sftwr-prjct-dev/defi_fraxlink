...
const SideBar = ({isOpened}) => {
    return (
        <div className={`${isOpened ? "block" : "hidden"} fixed overflow-y-scroll md:static md:block pt-10 md:pt-10 mt-0 md:mt-0 h-full md:h-screen w-10/12 bg-black border-t-2 border-r-2 border-gray-600 left-0 top-0 z-1 md:w-full`}>
            <ConnectionAndGas />
            ...
            <Socials className="flex w-full justify-between px-8 py-5 border-t border-borderCol" />
        </div>
    )
}
